...
$totalAdsSql = "SELECT COUNT(*) as total_ads FROM job_ads WHERE status = 'pending'";
...
<head>
    ...
    <title>Jobs Finder | Pending Ads</title>
...
<body>
    <div class="content-wrapper">
        ...
        <div class="container">
            <h1 class="text-center">Pending Ads</h1>
                    ...
                    <tbody>
                        <?php while ($row = $result->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="editad.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary">
