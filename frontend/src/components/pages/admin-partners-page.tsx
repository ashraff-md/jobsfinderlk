    ...
    <RecruiterAdminShell activeNav="partners">
      <AdminPageCanvas className="md:px-margin-desktop">
        ...
        <div className="overflow-hidden rounded-xl border border-outline-variant bg-surface-container-lowest">
          <div className="border-b border-outline-variant bg-surface-bright px-6 py-5">
            ...
            <table className="w-full min-w-[480px] border-collapse text-left">
              <thead>
                <tr className="border-b border-outline-variant bg-surface-container-low">
                  ...
                  <th className="px-6 py-4 text-right text-label-sm uppercase tracking-widest text-on-surface-variant">
                    Actions
                  </th>
                </tr>
              </thead>
