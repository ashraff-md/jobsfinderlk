...
export function AuthSignUpPage() {
  ...
  const emailPlaceholder = role === "seeker" ? "alex@corporate.com" : "hr@company.com";
        ...
        <div className="w-full max-w-[440px] space-y-stack-lg">
          ...
          <header className="space-y-stack-sm">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant">
              Join the executive talent network to discover elite roles or source leadership for
              your organization.
            </p>
          </header>
          ...
          <form className="space-y-stack-md" onSubmit={handleSubmit}>
            <div className="space-y-1">
              <label className="font-label-bold text-label-bold text-on-surface" htmlFor="full-name">
                Full Name
              </label>
            ...
            <div className="flex items-center gap-stack-sm py-2">
              ...
              >
                I agree to the{" "}
                <Link href="/legal/terms" className="font-label-bold text-secondary hover:underline">
                  Terms of Engagement
                </Link>{" "}
                and{" "}
                <Link href="/legal/privacy" className="font-label-bold text-secondary hover:underline">
                  Privacy Protocol
                </Link>
              </label>
            </div>
