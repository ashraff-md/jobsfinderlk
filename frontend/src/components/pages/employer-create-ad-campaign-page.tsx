...
export function EmployerCreateAdCampaignPage() {
  ...
  const onArtworkFile = async (file: File) => {
    ...
    try {
      ...
      setArtworkPreview(draft.previewUrl);
    } catch (e) {
  ...
  const validateStep = (targetStep: number): boolean => {
    ...
    if (targetStep > 2) {
      ...
      if (adType !== "sponsored" && !artworkPreview) {
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    const href = checkoutHrefForCampaign({
      adType,
      days: durationDays,
      campaignName,
      jobId: adType === "sponsored" ? selectedJob?.id : undefined,
    });
    router.push(href);
  };
                    ...
                    <div className="space-y-stack-lg">
                      {adType === "sponsored" ? (
                        <div>
                          ...
                          {jobs.length === 0 && (
                            <p className="mt-2 text-[12px] text-on-surface-variant">
                              <Link href="/employer/jobs/new" className="font-label-bold text-secondary hover:underline">
                                Post a job
                              </Link>{" "}
                        ...
                        <div>
                          ...
                          >
                            <Icon name="cloud_upload" className="mb-2 text-[48px] text-on-surface-variant" />
                            <p className="font-label-bold text-label-bold">Drag and drop your ad artwork</p>
                            <p className="mt-1 text-[12px] text-on-surface-variant">
                              {bannerArtworkSizeHint(
                                adType === "banner-tall" ? "tall" : "wide",
                              )}
                            </p>
            ...
            <div className="overflow-hidden rounded-xl border border-outline-variant bg-surface-container-lowest shadow-sm">
              <div className="flex items-center justify-between border-b border-outline-variant bg-surface-container-low p-stack-md">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-on-surface-variant">
                  {adType === "banner-tall" ? "2×5 Format" : adType === "banner-wide" ? "3×2 Format" : "Sponsored"}
                </span>
              </div>
              <div className="p-stack-lg">
                ...
                >
                  {artworkPreview ? (
                    <Image src={artworkPreview} alt="Ad preview" fill className="object-cover" unoptimized />
                  ) : (
              ...
              <div className="space-y-4 p-stack-lg">
                <div className="flex items-center justify-between text-body-md">
                  ...
                  <span className="font-bold text-primary">
                    LKR {pricing.base.toLocaleString()}
                  </span>
                </div>
                <div className="flex items-center justify-between text-body-md">
                ...
                <div className="flex items-end justify-between">
                  <div>
                    ...
                    <p className="text-[10px] text-on-surface-variant">Incl. all local taxes</p>
                  </div>
